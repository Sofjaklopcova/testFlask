...
from .models import Product, ProductType,evidence
from wtforms.validators import NumberRange
class EvidenceView(ModelView):
    datamodel = SQLAInterface(evidence)
    validators_columns = {
        'rok': [NumberRange(min=1900,max=2022, message='ROZSAH HODNOT 1900 AZ 2022')]
    }
...
db.create_all()
appbuilder.add_view(EvidenceView, "Our Products", icon="fa-folder-open-o")
